...
- [X] T016 Create CI workflow gates for Rust tests, pgrx SQL tests, PG matrix E2E, benchmarks, and memory checks in `/Users/jamal/git/pg-kalam/.github/workflows/ci.yml`
