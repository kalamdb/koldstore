...
- Run the local pgrx-backed E2E matrix with `tests/e2e/run_pg_matrix.sh`, which executes `cargo nextest run -p e2e --test-threads 1` after installing the extension.
