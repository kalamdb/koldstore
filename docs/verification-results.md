...
| `cargo nextest run --workspace --no-default-features --exclude e2e --exclude examples --exclude storage-comparison` | PASS | Workspace unit, integration, and doc tests passed; pgrx-backed E2E, examples, and storage comparison remain covered by their dedicated runners. |
