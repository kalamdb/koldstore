...
**Status:** Design approved 2026-08-07. Approach: extend footer-first reader + operator lists in `cold_metadata` (not catalog-mirrored page bounds, not DataFusion-only `RowFilter`).
