...
pub use resolver::{
    resolve_rows, NewestFirstWinnerResolver, ResolvedRow, RowSource, SeenKeyLimitExceeded,
};
pub use rls::{
...
pub use scan::{
    ...
    ColdAvailability, ColdPruneColumnPolicy, FilterPlan, MergeMetadataAttnums, MergeScanError,
