//! Cold DML planning types and decision helpers.
//!
//! Owns hydrate/update/delete route planning for managed tables. Mirror capture
//! stays in `koldstore-migrate`; PostgreSQL execution stays in `pg_koldstore`.
