...
pub use shared::{
    ...
    plan_mirror_oldest_rows_max_seq, plan_mirror_op_stats, plan_mirror_schema, plan_mirror_stats,
    ...
    MirrorError, MirrorRelation, MirrorResult, MirrorSchemaPlan, MirrorSeqStats, MirrorStatement,
    SqlParamType, CHANGE_LOG_MIRROR_SUFFIX, KOLDSTORE_SCHEMA,
};
pub use strict::{
