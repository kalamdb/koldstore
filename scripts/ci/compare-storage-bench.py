...
FOCUS_METRICS: list[tuple[str, str, bool]] = [
    ...
    ("main", "hot-after-flush-query p99 latency", False),
    ("main", "cold-query p99 latency", False),
    ("main", "hot-only query throughput (after flush)", True),
    ...
    ("main", "flush write throughput", True),
    ("main", "flush write bandwidth", True),
    ...
    ("detail", "query hot only (after flush)", True),
