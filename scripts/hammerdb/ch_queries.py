#!/usr/bin/env python3
"""CH-benCHmark-style analytical queries for HammerDB TPROC-C schemas.

Query text adapted from Citus citus-benchmark `ch_benchmark.py` (CH-benCHmark /
TUM), which extends TPC-C with region/nation/supplier. Not an official TPC-H run.
"""

from __future__ import annotations

# 22 analytical queries (Q1–Q22). Keep LIMIT 10 for bounded deep-harness runtime.
CH_QUERIES: list[str] = [
    """
-- Q1
select ol_number,
